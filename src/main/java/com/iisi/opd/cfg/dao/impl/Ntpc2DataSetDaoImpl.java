...
/*     */
/*     */ @Repository
/*     */ public class Ntpc2DataSetDaoImpl/*     */ extends GenericDaoImpl<DataSetPo>/*     */ implements Ntpc2DataSetDao
/*     */ {
    /*     */ @Override
    ...
    /*     */ {
        /*  31 */ DetachedCriteria criteria = createDetachedCriteriaForMultiCollectionSearch(unitOidList, categoryOidList,
                interval, null, null);
    ...
    /*     */ {
        /*  38 */ DetachedCriteria criteria = createDetachedCriteriaForMultiCollectionSearch(unitOidList, categoryOidList,
                interval, mataDataKey, mataDataValueList);
    ...
    public Pager dataSetMultiCollectionSearch(Pager pager, List<String> unitOidList, List<String> categoryOidList,
            IntervalBean interval, DataSetPo.OrderByOption orderByOption)
    /*     */ {
        /*  44 */ DetachedCriteria criteria = createDetachedCriteriaForMultiCollectionSearch(unitOidList, categoryOidList,
                interval, null, null);
    ...
    public Pager dataSetMultiCollectionSearch(Pager pager, List<String> unitOidList, List<String> categoryOidList,
            IntervalBean interval, String mataDataKey, List<String> mataDataValueList, DataSetPo.OrderByOption orderByOption)
    /*     */ {
        /*  50 */ DetachedCriteria criteria = createDetachedCriteriaForMultiCollectionSearch(unitOidList, categoryOidList,
                interval, mataDataKey, mataDataValueList);
        /*  51 */ return getPagerWithComplexStructure(pager, criteria, generateOrder(orderByOption));
        /*     */ }

    /*     */
    /*     */ private DetachedCriteria createDetachedCriteriaForMultiCollectionSearch(List<String> unitList,
            List<String> categoryList, IntervalBean interval, String mataDataKey, List<String> mataDataValueList) {
    ...
    /*     */ {
        /* 107 */ if (orderByOption == null)/* 108 */ return Order.desc("publicTime");
        /* 109 */ if (orderByOption == DataSetPo.OrderByOption.NEWEST_DESC)/* 110 */ return Order.desc("publishedDate");
        /* 111 */ if (orderByOption == DataSetPo.OrderByOption.OLDEST_ASC)/* 112 */ return Order.asc("publishedDate");
        /* 113 */ if (orderByOption == DataSetPo.OrderByOption.HOT_DESC) {
            ...
            /*     */ }
        /* 116 */ if (orderByOption == DataSetPo.OrderByOption.DATA_OUT_DESC)/* 117 */ return Order.desc("dataOutCount");
    ...
    /*     */ {
        ...
        /* 179 */ sqlStatment
                .append("\tLEFT JOIN [dbo].[od_data_set_metadata_apply] ODSMA1 ON ODSA.oid = ODSMA1.od_data_set_apply_oid \n");
        /* 180 */ sqlStatment.append("\t\t\tAND ODSMA1.metadata_key = 'contactName' \n");
        /* 181 */ sqlStatment
                .append("\tLEFT JOIN [dbo].[od_data_set_metadata_apply] ODSMA2 ON ODSA.oid = ODSMA2.od_data_set_apply_oid \n");
        ...
        /* 190 */ sqlStatment.append(
                "WHERE rid BETWEEN " + newPager.getCurrentStartRowIndex() + " AND " + newPager.getCurrentEndRowIndex() + " \n");
