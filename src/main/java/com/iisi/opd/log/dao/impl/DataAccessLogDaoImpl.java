...
/*     */
/*     */ @Repository
/*     */ public class DataAccessLogDaoImpl/*     */ extends GenericDaoImpl<DataAccessLogPo>/*     */ implements DataAccessLogDao
/*     */ {
    /*     */ @Override
    public void removeByDataSetOid(String dataSetOid)
    /*     */ {
        /*  29 */ DetachedCriteria criteria = DetachedCriteria.forClass(DataAccessLogPo.class);
        /*  30 */ criteria.add(Restrictions.eq("dataSetOid", dataSetOid));
        /*     */
        /*     */
        /*  33 */ List<DataAccessLogPo> removeList = getHibernateTemplate().findByCriteria(criteria);
    ...
    /*     */ {
        /*  40 */ DetachedCriteria criteria = DetachedCriteria.forClass(DataAccessLogPo.class);
        /*  41 */ criteria.add(Restrictions.eq("dataCfgOid", dataCfgOid));
        /*     */
        /*     */
        /*  44 */ List<DataAccessLogPo> removeList = getHibernateTemplate().findByCriteria(criteria);
    ...
    /*     */ {
        ...
        /*  51 */ DetachedCriteria criteria = DetachedCriteria.forClass(DataAccessLogPo.class);
    ...
    /*     */ {
        ...
        /*  71 */ DetachedCriteria criteria = DetachedCriteria.forClass(DataAccessLogPo.class);
    ...
    /*     */
    /*     */ @Override
    public Map<String, Long> getDataSetAccessViewStatistic(IntervalBean interval)
    /*     */ {
        /*  92 */ DetachedCriteria criteriaAsscess = DetachedCriteria.forClass(DataAccessLogPo.class);
        /*  93 */ criteriaAsscess.add(interval.getRestriction());
        /*     */
        /*  95 */ ProjectionList projectionList = Projections.projectionList();
        /*  96 */ criteriaAsscess.setProjection(projectionList);
        ...
        /* 101 */ List<Object[]> result = (List<Object[]>) getProjectionsQueryList(criteriaAsscess);
...
/* Location:              D:\MOI\OPENDATASOURCECODE\open-data\WebContent\WEB-INF\lib\opd.Ver769.jar!\com\iisi\opd\log\dao\impl\DataAccessLogDaoImpl.class
